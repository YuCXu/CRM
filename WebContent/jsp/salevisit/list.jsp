...
<BODY>
	<s:form id="customerForm" name="customerForm" action="saleVisit_findAll" namespace="/" method="post" theme="simple">
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间：从</TD>
													<TD>
														<input name="visit_time" id="visit_time" readonly="readonly" value="<s:date name="visit_time" format="yyyy-MM-dd"/>"/>
													</TD>
													<TD>到</TD>
													<TD>
														<input name="visit_end_time" id="visit_end_time" readonly="readonly" value="<s:date name="visit_end_time" format="yyyy-MM-dd"/>"/>
													</TD>
