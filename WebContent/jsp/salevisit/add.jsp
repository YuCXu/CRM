...
<script type="text/javascript">
	$(function(){
		//异步加载客户信息
		$.post("${pageContext.request.contextPath }/customer_findAllCustomer.action",{},
				function(data){
		...
		//异步加载用户信息
		$.post("${pageContext.request.contextPath }/user_findAllUser.action",{}
				,function(data){
			$(data).each(function(i,n){
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>拜访时间：</td>
								<td>
								<s:textfield readonly="true" cssClass="textbox" cssStyle="WIDTH: 180px" id="visit_time" maxLength="50" name="visit_time"/>
								</td>
								<td>拜访地点 ：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" id="sChannel2" maxLength="50" name="visit_addr"/>
								</td>
							</TR>
							<TR>
								<td>拜访详情 ：</td>
								<td>
								<s:textfield cssClass="textbox" cssStyle="WIDTH: 180px" id="sChannel2" maxLength="50" name="visit_detail"/>
								</td>
								<td>下次拜访时间 ：</td>
								<td>
								<s:textfield readonly="true" cssClass="textbox" cssStyle="WIDTH: 180px" id="visit_nexttime" maxLength="50" name="visit_nexttime"/>
								</td>	
							</TR>
							<tr>
								<td rowspan=2>
