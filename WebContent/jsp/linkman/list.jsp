...
<BODY>
	<s:form id="customerForm" name="customerForm" action="" namespace="/" method="post" theme="simple">
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
													<s:textfield name="lkm_name" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50" id="sChannel2"/>
													</TD>
													<TD>联系人性别：</TD>
													<TD>
